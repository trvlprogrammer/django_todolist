...
from .api import TodoItemViewset, TodoItemArchiveViewset,TagItemViewset


app_name = "todos"   

router = routers.DefaultRouter()
router.register('api/todos/archive', TodoItemArchiveViewset, 'archive')
router.register('api/todos', TodoItemViewset, 'todos')
router.register('api/tags', TagItemViewset, 'tags')
...
urlpatterns = [
    ...
    path("todo/<pk>/archive/<str:name>", login_required(views.TodoArchiveView.as_view()), name="archive_todo"),
